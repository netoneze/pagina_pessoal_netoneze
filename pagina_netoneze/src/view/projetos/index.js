    ...
    return (
            <main className="item-container" id="itemPrincipal">
                <div className="principal">
                    ...
                    <h2 className="titulo-principal titulo-projeto">Easy Task Manager</h2>
                    <a href="https://play.google.com/store/apps/details?id=com.netoneze.easytaskmanager&hl=pt">
                        <img className="imagens-corpo imagens-corpo-proj" src={Proj2} alt="projeto2" title="Easy Task Manager"/>
                    </a>
                    <p>
                        Um aplicativo de <strong>gerenciamento de tarefas</strong> desenvolvido em Java, utilizando padrões ROOM e MVC.
                    </p>

                    <br/>

                    <h2 className="titulo-principal titulo-projeto titulo-projeto-proj3">NelsonGenda</h2>
